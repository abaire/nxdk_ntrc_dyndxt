...
#define CACHE1_DMA_PUSH _PFIFO_ADDR(NV_PFIFO_CACHE1_DMA_PUSH)
#define CACHE1_PULL0 _PFIFO_ADDR(NV_PFIFO_CACHE1_PULL0)
#define CACHE1_PUT_ADDR _PFIFO_ADDR(NV_PFIFO_CACHE1_PUT)
#define CACHE1_GET_ADDR _PFIFO_ADDR(NV_PFIFO_CACHE1_GET)
...
#define PGRAPH_FIFO_STATE _PGRAPH_ADDR(NV_PGRAPH_FIFO)
#define NV_PGRAPH_STATUS 0x00000700
#define NV_PGRAPH_STATUS_BUSY 0x00000001
...
#define PGRAPH_SHADERPROG _PGRAPH_ADDR(NV_PGRAPH_SHADERPROG)
