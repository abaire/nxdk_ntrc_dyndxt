...
// Failing to send it in a tight modification loop will cause the hardware to
// re-use previously set data even if new values are set (likely it skips
// fetching the updated memory from system RAM).
